            ...
            <div class="d-flex">
                <nav>
                    ...
                    <ul class="nav flex-column mt-4">
                        <li class="nav-item"><a href="/lesson05/weather_history" class="nav-link main-link">날씨</a></li>
                        <li class="nav-item"><a href="/lesson05/weather_input" class="nav-link main-link">날씨입력</a></li>
